...
public interface LandRepository extends BasicRepository<Land, ObjectId> {
	...
	public List<Land> getList(IContext<ObjectId> context, 
			String text, String landName, String farmerName, 
			Collection<ObjectId> landIds, 
