...
<div class="container-modal-search">
	<div class="row">
		<div class="col-md-12 col-sm-12 following">
			<form:form id="form-search" action="${pageContext.request.contextPath}/modal-search/land/search" 
					...
					<div class="row">
						<div class="col-md-5 col-sm-6 col-xs-12">
							<form:input path="text" class="form-control"
									placeholder="Tên thửa đất, tên nhà nông" id="searchText" name="searchText" autofocus="autofocus" />
						</div>
						<div class="col-md-7 col-sm-6 col-xs-12 md-margin-top-10">
							<div class="input-group">
								<form:select path="categoryIds" id="categoryId" name="categoryId" 
									...
									<option value="">Tất cả loại thửa đất</option>
	...
	<div class="row table-row table-result following">
		<form:form id="form-select" action="${pageContext.request.contextPath}/modal-search/land/select" 
					...
					<div class="card-box table-cell-content padding-bottom-none">
						<div class="item-farmer hover padding-none margin-none" id="resource_${ dto.id }">
							...
							<div class="name-of-farmer text-muted font-13" id="resource_${ dto.id }_content">
								<c:set var="landItemDto" value="${dto}" scope="request" />
